...
function fixture() {
  ...
  db.exec(`
    ...
    CREATE TABLE sessions (id TEXT PRIMARY KEY, project_id TEXT, harness TEXT, title TEXT, cwd TEXT, kind TEXT, retention TEXT NOT NULL DEFAULT 'permanent', parent_session_id TEXT, forked_at_seq INTEGER, fork_request_id TEXT, context_method TEXT, context_confidence TEXT, status TEXT, auto_resume INTEGER, created_at INTEGER, last_activity_at INTEGER);
